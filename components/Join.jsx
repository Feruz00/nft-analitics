...
const Social = ({ icon, name, text, type }) => (
  <div className="w-[45%]  relative border-4 border-white p-5 rounded-xl  sm:mb-10  sm:w-[90%] xs:w-full">
    ...
    <h1 className="mt-10 text-center text-white font-bold text-2xl xs:text-xl">{name}</h1>
    <p className="text-center text-sm font-medium text-white">{text}</p>
    <div className="w-full flex items-center justify-center my-2 sm:m-0 sm:my-2">
      <div className="flex text-white justify-center w-1/2 bg-blue-500
      font-bold px-10 text-lg rounded-xl cursor-pointer transation duration-500 hover:bg-blue-600
        xs:text-sm xs:py-1
      "
      >
        Follow
...
const Join = () => (
  <div className="w-full  flex flex-row items-center xmd:flex-col xmd:justify-around">

    <div className=" flex flex-col w-[45%] xmd:mb-14 sm:items-center sm:mt-6 xmd:w-full ">

      <div className="flex flex-col justify-start sm:justify-center mb-10">
        <div className="flex flex-row mb-5 items-center justify-center">
          <h1 className="font-bold text-4xl text-white mr-1 sm:text-2xl xs:text-xl">Join Our Community!</h1>
          <Image src={hand} className="filter invert sm:w-4 sm:h-4" width={36} height={36} />

        </div>

        <p className="font-regular sm:text-center text-white font-medium text-lg sm:text-base">Get NFT drops, whale activies and updates right to your inbox! Be first to hear about breaking news!</p>
